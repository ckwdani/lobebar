...
/**
 * @extends ServiceEntityRepository<ResetCode>
 *
...
class ResetCodeRepository extends ServiceEntityRepository
{
    ...
    public function save(ResetCode $entity, bool $flush = false): void
    {
    ...
    public function remove(ResetCode $entity, bool $flush = false): void
    {
...
//    /**
//     * @return ResetCode[] Returns an array of ResetCode objects
//     */
...
//    public function findOneBySomeField($value): ?ResetCode
//    {
//        return $this->createQueryBuilder('r')
//            ->andWhere('r.exampleField = :val')
//            ->setParameter('val', $value)
